...
it('pass props to base constructor', () => {
  const bottomNotification = new BottomNotification("title1", "desc1", NotificationTypes.ERROR);
...
it('should have prop TimeToClose', () => {
  ...
  const bottomNotification = new BottomNotification("title1", "desc1", NotificationTypes.ERROR, timeToClose);
